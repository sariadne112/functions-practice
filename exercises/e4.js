...
var personObject = { id: 1, name: "Someone", age: 32 };
...
const isNameInArray = (arr, name) => people.includes(name);
var people = ["Jon", "Michael", "Andrey"];
console.log(people.includes("Michael"));
console.log(people.includes("James"));
